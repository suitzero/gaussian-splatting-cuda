...
void PicoStrategy::ExponentialLR::step() {
...
torch::Tensor PicoStrategy::multinomial_sample(const torch::Tensor& weights, int n, bool replacement) {
...
void PicoStrategy::update_optimizer_for_relocate(torch::optim::Optimizer* optimizer,
...
void PicoStrategy::inject_noise() {
    // Get opacities and handle both [N] and [N, 1] shapes
    torch::NoGradGuard no_grad;
